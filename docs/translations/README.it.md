...
La v1.2.1 mantiene Paperclip 2026.831.1, quindi non aggiunge una nuova migrazione Paperclip. Per tornare indietro, ripristina i volumi home, cache e workspace intatti creati prima dell'aggiornamento con l'immagine `1.2.0`; non riutilizzare volumi già avviati con la v1.2.1.
