...
**फिलहाल मल्टी-एजेंट प्लगइन खुद मैनेज करें।** HolyCode द्वारा मैनेज की जाने वाली oh-my-openagent इंस्टॉलेशन v1.1.4 में सस्पेंड है। पुरानी सेटिंग हटाने के बाद पहला सफल स्टार्ट पुराने मैनेज्ड प्लगइन एंट्री को निष्क्रिय करता है और सेटिंग्स, Skills तथा पैकेज कैश सुरक्षित रखता है।
...
Compose सेटअप HolyCode की Chromium seccomp प्रोफ़ाइल का उपयोग करता है। अगर आप repository clone से नहीं चला रहे हैं, तो पहले release copy डाउनलोड करें:
...
| `ENABLE_OH_MY_OPENAGENT` | (कोई नहीं) | पुरानी सेटिंग; `true` बिना बदलाव स्टार्टअप रोकता है, फिर इसे हटाने पर एक बार का माइग्रेशन पुरानी सक्रिय एंट्री निष्क्रिय करता है |
...
> v1.2.1 में OpenCode 1.18.30, Claude Code 2.1.270, Undici 6.28.1 के साथ Paperclip 2026.831.1, npm 12.0.2, pnpm 12.4.1, ESLint 10.10.0, Miniflare 5.20260911.1-alpha और workerd 1.20260911.1 के साथ Wrangler 4.131.2, Prisma 7.10.0, TypeScript 6.0.3 और json-server 0.17.4 शामिल हैं। Python में Matplotlib 3.11.2, tqdm 4.70.1, FastAPI 0.141.1, Uvicorn 0.53.0 और NumPy 2.5.3 हैं। `opencode-claude-auth` 2.2.0 image में पैक है और स्टार्टअप पर offline इंस्टॉल होता है। Netlify CLI और npm पैकेज `serve` image में शामिल नहीं हैं। HolyCode द्वारा मैनेज की जाने वाली oh-my-openagent इंस्टॉलेशन सस्पेंड है, Hermes अभी भी उपलब्ध नहीं है और बाहर से मैनेज किए गए CLIProxyAPI endpoint समर्थित रहते हैं।
...
Paperclip OpenCode के ऊपर ऑप्शनल सर्विस के रूप में बंडल रहता है। CLIProxyAPI इंटीग्रेशन बाहर से प्रबंधित endpoint का उपयोग करता है। Hermes अस्थायी रूप से image में शामिल नहीं है।
...
### oh-my-openagent माइग्रेशन

HolyCode v1.1.4 में oh-my-openagent इंस्टॉल या अपडेट नहीं करता। `ENABLE_OH_MY_OPENAGENT=true` होने पर स्टार्टअप प्लगइन की स्थिति बदले बिना रुकता है। इसे हटाने के बाद पहला सफल स्टार्ट पुरानी एंट्री निष्क्रिय करता है, उसका पैकेज संदर्भ दर्ज करता है और सेटिंग्स, Skills तथा कैश सुरक्षित रखता है। बाद में प्लगइन को मैन्युअल रूप से फिर जोड़ने पर HolyCode उसे आपके द्वारा मैनेज किया हुआ मानता है।
...
v1.2.1 में Paperclip 2026.831.1 पर ही रहता है, इसलिए Paperclip का कोई नया migration नहीं है। Rollback के लिए अपग्रेड से पहले के untouched home, cache और workspace volumes को image `1.2.0` के साथ restore करें; v1.2.1 के साथ पहले ही शुरू किए गए volumes दोबारा इस्तेमाल न करें।
...
<details>
<summary><strong>HolyCode Chromium sandbox का उपयोग कैसे करता है?</strong></summary>

Chromium `opencode` user के रूप में अपने built-in sandbox के साथ चलता है। Compose files सीमित `config/chromium-seccomp.json` profile को अपने आप load करती हैं।

अगर आप container खुद चलाते हैं, तो वही profile load करें:
...
Sandbox को बंद न करें और container को अतिरिक्त privileges न दें।
