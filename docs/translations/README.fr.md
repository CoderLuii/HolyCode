...
v1.2.0 conserve Paperclip 2026.831.1 et n'ajoute donc aucune migration Paperclip. Pour revenir en arrière, restaurez les volumes personnels, de cache et de travail intacts datant d'avant la mise à jour avec l'image `1.1.9` ; ne réutilisez pas de volumes déjà démarrés avec v1.2.0.
