...
В v1.2.1 сохраняется Paperclip 2026.831.1, поэтому новых миграций Paperclip нет. Для отката восстановите нетронутые домашние, кэш- и рабочие тома, созданные до обновления, с образом `1.2.0`; не используйте повторно тома, которые уже запускались с v1.2.1.
