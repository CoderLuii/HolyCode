...
Остановите контейнер и сохраните резервные копии домашнего и рабочего томов до загрузки последнего образа.
